...
UX_SLAVE_CLASS_CDC_ACM  *cdc_acm_1, *cdc_acm_2;
...
/**
  ...
  * @retval none
  */
VOID USBD_CDC_ACM_Activate_1(VOID *cdc_acm_instance)
{
  /* USER CODE BEGIN USBD_CDC_ACM_Activate */

  /* Save the CDC instance */
  cdc_acm_1 = (UX_SLAVE_CLASS_CDC_ACM*) cdc_acm_instance;
  ...
  if (ux_device_class_cdc_acm_ioctl(cdc_acm_1, UX_SLAVE_CLASS_CDC_ACM_IOCTL_SET_LINE_CODING,
...
/**
  ...
  * @retval none
  */
VOID USBD_CDC_ACM_Deactivate_1(VOID *cdc_acm_instance)
{
...
/**
  ...
  * @retval none
  */
VOID USBD_CDC_ACM_ParameterChange_1(VOID *cdc_acm_instance)
{
  ...
  switch (request)
  {
    case UX_SLAVE_CLASS_CDC_ACM_SET_LINE_CODING :
      ...
      if (ux_device_class_cdc_acm_ioctl(cdc_acm_1, UX_SLAVE_CLASS_CDC_ACM_IOCTL_GET_LINE_CODING,
                                        &CDC_VCP_LineCoding) != UX_SUCCESS)
      {
        Error_Handler();
      }
...
/* USER CODE BEGIN 1 */
VOID USBD_CDC_ACM_Activate_2(VOID *cdc_acm_instance)
{
  /* USER CODE BEGIN USBD_CDC_ACM_Activate */
...
/**
  ...
  * @retval none
  */
VOID USBD_CDC_ACM_Deactivate_2(VOID *cdc_acm_instance)
{
  /* USER CODE BEGIN USBD_CDC_ACM_Deactivate */
  UX_PARAMETER_NOT_USED(cdc_acm_instance);
...
/**
  ...
  * @retval none
  */
VOID USBD_CDC_ACM_ParameterChange_2(VOID *cdc_acm_instance)
{
  /* USER CODE BEGIN USBD_CDC_ACM_ParameterChange */
  UX_PARAMETER_NOT_USED(cdc_acm_instance);
...
VOID usbx_cdc_acm_read_thread_entry(ULONG thread_input)
{
  ...
  while (1)
  {
    ...
    if ((device->ux_slave_device_state == UX_DEVICE_CONFIGURED) && (cdc_acm_1 != UX_NULL))
    {
      ...
      ux_device_class_cdc_acm_read(cdc_acm_1, (UCHAR *)UserRxBufferFS, 64,
                                   &actual_length);
      if (actual_length != 0)
      {
...
VOID usbx_cdc_acm_write_thread_entry(ULONG thread_input)
{
  ...
  while (1)
  {
    ...
    if (UserTxBufPtrOut != UserTxBufPtrIn)
    {
      ...
      if (ux_device_class_cdc_acm_write(cdc_acm_1, (UCHAR *)(&UserTxBufferFS[buffptr]),
